...
public class DeadLeavesBlock extends LukesModModElements.ModElement {

	@ObjectHolder("lukes_mod:dead_leaves")
	public static final Block block = null;

	public DeadLeavesBlock(LukesModModElements instance) {
		super(instance, 8);
